...
public abstract class GenericDialogConsulta extends JDialog {
	...
	public GenericDialogConsulta(Frame owner, String title, boolean modal, Connection connection) {
	...
	private void initComponents() {
		this.setBounds(100, 100, 516, 420);
		...
		label.setIcon(new ImageIcon(GenericFormCadastro.class.getResource("/br/com/estatistica/util/icons/logo/Logo-vers-1(16-09)min.png")));
		label.setForeground(new Color(220, 220, 220));
		label.setFont(new Font("Calibri Light", Font.BOLD, 20));
		label.setBounds(13, 11, 143, 81);
		panel_1.add(label);
